...
export default function SignUp() {
  ...
  const handleSubmit = async (e) => {
    ...
    // if (users) {
    //   const userExist = users.some((item) => item.email === formData.email);
        ...
        <div className="flex flex-col justify-center flex-1 w-full max-w-md mx-auto">
          <div>
            ...
            <div className="grid grid-cols-1 gap-3 ">
              <button onClick={()=> toast.success("Test for toast")} className="cursor-pointer inline-flex items-center justify-center gap-3 py-3 text-sm font-normal text-gray-700 transition-colors bg-gray-100 rounded-lg px-7 hover:bg-gray-200 hover:text-gray-800 ">
                <FcGoogle size={21} />
                Sign up with Google
              </button>
            </div>
